...
void quit() {
	...
	if (shutDownEnabled) {
		...
		if (selectedShutDownOption == 1) {
			...
			if (audioFix == 1){
				if (mmModel)
					...
					execlp("sh", "sh", "-c", "echo MMP_with_audiofix && killall main && killall updater && killall audioserver && killall audioserver.plu && killall batmon && killall keymon && swapoff /mnt/SDCARD/cachefile && sync && sleep 5 && umount -l /mnt/SDCARD && poweroff", NULL);
			} else if (audioFix == 0){
				if (mmModel)
					...
					execlp("sh", "sh", "-c", "echo MMP_without_audiofix && killall main && killall updater  && killall batmon && killall keymon && swapoff /mnt/SDCARD/cachefile && sync && sleep 5 && umount -l /mnt/SDCARD && poweroff", NULL);
			}	
			#else
		...
		if (selectedShutDownOption == 1) {
			...
			if (audioFix == 1){
				if (mmModel)
					execlp("sh", "sh", "-c", "killall main && killall updater && killall audioserver && killall audioserver.min  && killall batmon && killall keymon && swapoff /mnt/SDCARD/cachefile && sync && sleep 5 && umount -l /mnt/SDCARD && reboot", NULL);
				else
					execlp("sh", "sh", "-c", "killall main && killall updater && killall audioserver && killall audioserver.plu  && killall batmon && killall keymon && swapoff /mnt/SDCARD/cachefile && sync && sleep 5 && umount -l /mnt/SDCARD && poweroff", NULL);
			} else if (audioFix == 0){
				if (mmModel)
					execlp("sh", "sh", "-c", "killall main && killall updater  && killall batmon && killall keymon && swapoff /mnt/SDCARD/cachefile && sync && sleep 5 && umount -l /mnt/SDCARD && reboot", NULL);
				else
					execlp("sh", "sh", "-c", "killall main && killall updater  && killall batmon && killall keymon && swapoff /mnt/SDCARD/cachefile && sync && sleep 5 && umount -l /mnt/SDCARD && poweroff", NULL);
			}
			#else
			execlp("sh", "sh", "-c", "sync && poweroff", NULL);
			#endif
