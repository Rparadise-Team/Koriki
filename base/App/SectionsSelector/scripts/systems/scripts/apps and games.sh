...
cat > ${consoles} <<EOF
[CONSOLES]
consoleList = APPS,GAMES,OVERLAYS,AMIGA,AMSTRAD CPC,ATARI ST,COMMODORE 64,MSX,X68000,DOS,PC98,ZX SPECTRUM,SCUMMVM,OPENBOR,PICO-8,TIC-80,DOOM,QUAKE,WOLF3D,CPS1,CPS2,CPS3,NEO GEO,MAME,FINALBURN ALPHA,FINALBURN NEO,DAPHNE,ATARI LYNX,GAME & WATCH,GAME BOY,GAME BOY COLOR,GAME BOY ADVANCE,GAME GEAR,NEO GEO POCKET,POKEMON MINI,SUPERVISION,WONDERSWAN,ATARI 2600,ATARI 5200,ATARI 7800,INTELLIVISION,SEGA SG-1000,MASTER SYSTEM,NES,FDS,NEO GEO CD,PC ENGINE,PC ENGINE CD,PLAYSTATION,SEGA GENESIS,MSU-MD,SEGA 32X,SEGA CD,SNES,MSU-1,SGB,VIRTUAL BOY
