...
cat > ${consoles} <<EOF
[CONSOLES]
consoleList = AMIGA,AMSTRAD CPC,APPS,ATARI 2600,ATARI 5200,ATARI 7800,ATARI LYNX,ATARI ST,COMMODORE 64,CPS1,CPS2,CPS3,DAPHNE,DOOM,DOS,FDS,FINALBURN ALPHA,FINALBURN NEO,GAME & WATCH,GAME BOY,GAME BOY ADVANCE,GAME BOY COLOR,GAME GEAR,GAMES,INTELLIVISION,MAME,MASTER SYSTEM,MSU-1,MSU-MD,MSX,NES,NEO GEO,NEO GEO CD,NEO GEO POCKET,OPENBOR,OVERLAYS,PC98,PC ENGINE,PC ENGINE CD,PICO-8,PLAYSTATION,POKEMON MINI,QUAKE,SCUMMVM,SGB,SEGA 32X,SEGA CD,SEGA GENESIS,SEGA SG-1000,SNES,SUPERVISION,TIC-80,VIRTUAL BOY,WOLF3D,WONDERSWAN,X68000,ZX SPECTRUM
