...
[SEGA SG-1000]
execs = /mnt/SDCARD/.simplemenu/launchers/gearsystem_libretro,/mnt/SDCARD/.simplemenu/launchers/genesis_plus_gx_libretro,/mnt/SDCARD/.simplemenu/launchers/picodrive_libretro,/mnt/SDCARD/.simplemenu/launchers/picodrive_standalone,/mnt/SDCARD/.simplemenu/launchers/picodrive_netplay_libretro
...
[SEGA GENESIS]
execs = /mnt/SDCARD/.simplemenu/launchers/picodrive_libretro,/mnt/SDCARD/.simplemenu/launchers/genesis_plus_gx_libretro,/mnt/SDCARD/.simplemenu/launchers/picodrive_standalone,/mnt/SDCARD/.simplemenu/launchers/picodrive_netplay_libretro,/mnt/SDCARD/.simplemenu/launchers/genesis_plus_gx_mod_libretro
romDirs = /mnt/SDCARD/Roms/MD/
romExts = .zip,.bin,.smd,.md,.mdx,.gen,.7z

[SEGA CD]
execs = /mnt/SDCARD/.simplemenu/launchers/picodrive_libretro,/mnt/SDCARD/.simplemenu/launchers/genesis_plus_gx_libretro,/mnt/SDCARD/.simplemenu/launchers/picodrive_standalone,/mnt/SDCARD/.simplemenu/launchers/picodrive_netplay_libretro
romDirs = /mnt/SDCARD/Roms/SEGACD/
romExts = .bin,.chd,.cue

[SEGA 32X]
execs = /mnt/SDCARD/.simplemenu/launchers/picodrive_libretro,/mnt/SDCARD/.simplemenu/launchers/picodrive_standalone,/mnt/SDCARD/.simplemenu/launchers/picodrive_netplay_libretro
